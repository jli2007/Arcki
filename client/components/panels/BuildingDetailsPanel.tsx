...
export function BuildingDetailsPanel({
  ...
  return (
    <div className="absolute right-4 top-[45%] -translate-y-1/2 z-10 w-[18vw] min-w-70 max-w-[320px] flex flex-col rounded-2xl bg-black/40 backdrop-blur-md border border-white/10 shadow-xl overflow-hidden">
      <button
        onClick={onClose}
      ...
      {!isDrawMode && (
        <div className="relative w-full aspect-3/2 bg-gray-800 shrink-0">
          ...
          {imageError ? (
            <div className="absolute inset-0 flex items-center justify-center bg-linear-to-br from-gray-700 to-gray-900">
      ...
      <div className="p-4">
        {isDrawMode ? (
          <>
            <h3 className="text-white font-semibold text-lg tracking-tight font-serif">
              Selected Area
            </h3>
